...
base_dir = f"./{modality}_splits/both_45_45_10_#1"
...
train_1_dir = os.path.join(base_dir, "train_1.txt")
...
for file, split in [(train_1_file, train_1), (train_2_file, train_2), (val_file, val)]:
